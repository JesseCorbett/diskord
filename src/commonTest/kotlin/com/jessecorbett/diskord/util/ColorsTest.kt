...
class ColorsTest {
    @Test fun `should convert rgb floats to color`() {
    ...
    @Test fun `should throw exception for out-of-range rgb floats`() {
    ...
    @Test fun `should convert rgb integers to color`() {
    ...
    @Test fun `should throw exception for out-of-range rgb integers`() {
    ...
    @Test fun `should convert hex integer to color`() {
    ...
    @Test fun `should convert hex string to color`() {
    ...
    @Test fun `should throw an exception for invalid hex strings`() {
    ...
    @Test fun `should throw exception for out-of-range hex values`() {
    ...
    @Test fun `should convert color to rgb triple`() {
